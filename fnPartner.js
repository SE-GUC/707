...
const functions = {
  ...
  getPartner: async (token) => {
    const partner = await axios.get(
      "http://localhost:5000/api/partners/profile", {
        headers: {
          Authorization: token
        }
      }
  ...
  updatePartner: async (token, updatedata) => {
    const partner = await axios.put(
      "http://localhost:5000/api/partners/updateProfile", {
        headers: {
          Authorization: token
        }
      }, updatedata
  ...
  postPartnerConversation: async (token, conversation) => {
    const response = await axios.post(
      "http://localhost:5000/api/partners/conversations/start", {
        headers: {
          Authorization: token
        }
      }, conversation
  ...
  getPartnerConversation: async (token) => {
    const conv = await axios.get(
      "http://localhost:5000/api/partners/conversations/get", {
        headers: {
          Authorization: token
        }
      }
  ...
  getPartnerConversationbyemail: async (token, email) => {
    const response = await axios.get(
      "http://localhost:5000/api/partners/conversations/get/" + email, {
        headers: {
          Authorization: token
        }
      }
  ...
  deletePartnerConversation: async (token, email) => {
    const response = await axios.delete(
      "http://localhost:5000/api/partners/conversations/delete/" + email, {
        headers: {
          Authorization: token
        }
      }
  ...
  postPartneremailConversation: async (token, conversationemail) => {
    const response = await axios.post(
      "http://localhost:5000/api/partners/conversations/send", {
        headers: {
          Authorization: token
        }
      }, conversationemail
  ...
  getmyProjects: async (token) => {
    var names = await axios.get(
      "http://localhost:5000/api/partners/projects/", {
        headers: {
          Authorization: token
        }
      }
  ...
  deleteProjectbyId: async (token, projectId) => {
    const deletedproject = await axios.delete(
      "http://localhost:5000/api/partners/project/" + projectId, {
        headers: {
          Authorization: token
        }
      }
