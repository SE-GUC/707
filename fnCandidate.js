...
const functions = {
  ...
  postConversation: async (conv, token) => {
    const response = await axios.post(
      "http://localhost:5000/api/candidates/conversations/start", conv, {
        headers: {
          Authorization: token
        }
      }
  ...
  getConversations: async (token) => {
    const conversations = await axios.get(
      "http://localhost:5000/api/candidates/conversation/get", {
        headers: {
          Authorization: token
        }
      }
  ...
  getConversation: async (token, email) => {
    const conversation = await axios.get(
      "http://localhost:5000/api/candidates/conversations/get/" + email, {
        headers: {
          Authorization: token
        }
      }
  ...
  postemailConversation: async (email, token) => {
    const response = await axios.post(
      "http://localhost:5000/api/candidates/conversations/send", email, {
        headers: {
          Authorization: token
        }
      }
  ...
  putCandidate: async (token, candidate) => {
    const response = await axios.put(
      "http://localhost:5000/api/candidates/updateProfile", candidate, {
        headers: {
          Authorization: token
        }
      }
  ...
  applyforProjectbyID: async (token, projectID) => {
    const response = await axios.post(
      "http://localhost:5000/api/candidates/project/", {
        headers: {
          Authorization: token
        }
      }, "/" + projectID
  ...
  viewAllProjectsiAppliedFor: async (token) => {
    var projects = await axios.get(
      "http://localhost:5000/api/candidates/appliedProjects/", {
        headers: {
          Authorization: token
        }
      }
