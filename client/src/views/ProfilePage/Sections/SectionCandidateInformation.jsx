...
class SectionCandidateInformation extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      modal: false,
                          ...
                          <DialogContent>
                            ...
                            >
                              ...
                              <Input
                                ...
                                onChange={this.handleChangeMultiple("courses")}
                                endAdornment={
                                  <InputAdornment position="end">
                                    <CastForEducation
                                      className={classes.inputIconsColor}
...
export default withStyles(productStyle)(SectionCandidateInformation);
