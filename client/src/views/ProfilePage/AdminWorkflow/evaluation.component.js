...
export default class evaluation extends Component {
  ...
  deleteOneEvaluation(id) {
    ...
    axios
      .delete(
        "http://localhost:5000/api/admins/certificate/evaluationTests/" +
  ...
  editOneEvaluation(id) {
    ...
    if (!this.state.contexteditable) {
      axios
        .get(
          "http://localhost:5000/api/admins/certificate/evaluationTest/" + id,
          {
            headers: {
              Authorization: token
            }
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <button
                      id="btn1"
                      onClick={this.editOneEvaluation.bind(this, person._id)}
                    >
                      Edit{" "}
                    </button>
                  </td>
                  <td>
                    ...
                    <button
                      id="btn2"
                      onClick={this.deleteOneEvaluation.bind(this, person._id)}
                    >
                      Delete
                    </button>
                  </td>
      ...
      return (
        <Form>
          ...
          <Form.Group controlId="formPassing">
            ...
            <Form.Control
              type="text"
              placeholder={this.state.passing}
              onChange={this.onChangePassing}
            />
          </Form.Group>
          ...
          <button
            id="btn1"
            onClick={this.editOneEvaluation.bind(this, this.state.eval_id)}
          >
            Edit
          </button>
        </Form>
