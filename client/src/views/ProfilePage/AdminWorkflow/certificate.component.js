...
export default class Certificate extends Component {
  ...
  onSubmit(e) {
    ...
    axios
      .post("http://localhost:5000/api/admins/certificate", certificate, {
        headers: {
          Authorization: token
        }
      })
  ...
  showAllEvaluations = id => {
    window.location.replace("/AdminWorkflow/Evaluations/" + id);
  };
  onSubmit4(id) {
    const cookies = new Cookies();
    ...
    axios
      .get("http://localhost:5000/api/admins/certificate/" + id, {
        headers: {
          Authorization: token
        }
      })
  ...
  onSubmit3(id) {
    ...
    axios
      .post(
        "http://localhost:5000/api/admins/certificate/evaluationTests/" + id,
        Eval,
        {
          headers: {
            Authorization: token
  ...
  onSubmit2(id) {
    ...
    axios
      .delete("http://localhost:5000/api/admins/certificate/" + id, {
        headers: {
          Authorization: token
        }
      })
  ...
  async updateCertificate(certificate) {
    ...
    if (!this.state.contexteditable) {
      ...
      axios
        .put(
          "http://localhost:5000/api/admins/certificate/" + certificate._id,
          certificate2,
          {
            headers: {
              Authorization: token
  ...
  async newEvaluation(certificate) {
    this.setState({ certificate: certificate, createEvaluation: true });
  }
                  ...
                  <tr>
                    ...
                    <td>
                      <button
                        type="button"
                        className="btn btn-danger"
                        onClick={this.showAllEvaluations.bind(this, person._id)}
                      >
                        Show All Evaluations Information
                      </button>
                    </td>
                    <td>
                      <button
                        type="button"
                        onClick={this.newEvaluation.bind(this, person)}
                      >
                        New Evaluation
                      </button>
                      <br />
                    ...
                    <td>
                      <button
                        type="update"
                        onClick={this.updateCertificate.bind(this, person)}
                      >
                        Edit
                      </button>
                      <br />
                    ...
                    <td>
                      <button
                        type="button"
                        className="btn btn-danger"
                        onClick={this.onSubmit4.bind(this, person._id)}
                      >
                        View
                      </button>
                      <br />
        ...
        return (
          <Form>
            <Form.Group controlId="formName">
              ...
              <Form.Control
                type="text"
                placeholder={this.state.certificateName}
                onChange={e => this.onChangeCertificateName(e)}
              />
              <Form.Text className="text-muted">
                Please Enter the content to update
              </Form.Text>
            </Form.Group>
            <Form.Group controlId="formDescription">
              ...
              <Form.Control
                type="text"
                placeholder={this.state.certificateDescription}
                onChange={e => this.onChangeCertificateDescription(e)}
              />
            </Form.Group>
            <Form.Group controlId="formCategory">
              ...
              <Form.Control
                type="text"
                placeholder={this.state.certificateCategory}
            ...
            <Form.Group controlId="formSkills">
              ...
              <Form.Control
                ...
                onChange={e => this.onChangeSkills(e)}
              />
            </Form.Group>
            <button
              id="btn1"
              onClick={this.updateCertificate.bind(
                this,
          ...
          <Form>
            <Form.Row>
              <Form.Group as={Col} controlId="formGridContent">
                ...
                <Form.Control
                  type="text"
                  placeholder="Write a berif description about the evaluation"
            ...
            <Form.Row>
              <Form.Group as={Col} controlId="formGridType">
                ...
                <Form.Control
                  as="select"
                  onChange={e => this.onChangeEvalType(e)}
                >
            ...
            <Form.Row>
              <Form.Group as={Col} controlId="formGridCreateEval">
                <button
                  type="button"
                  className="btn btn-danger"
                  onClick={this.onSubmit3.bind(
                    this,
                    this.state.certificate._id
                  )}
                >
                  Add Evaluation
                </button>
