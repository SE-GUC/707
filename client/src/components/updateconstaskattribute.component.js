...
export default class updateconstaskattribute extends Component {
  ...
  rerender(token) {
    ...
    axios
      .get("http://localhost:5000/api/consultancies/task/" + { task }.task, {
        headers: {
          Authorization: token
        }
      })
          ...
          <p>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={e =>
                  this.onChangeProjectDescription(this.state.task, e)
                }
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                onChange={e =>
                  this.onChangeYearsofExperience(this.state.task, e)
                }
              />
            </div>
            <div className="form-group">
            ...
            <button
              type="update"
              onClick={event => this.updateproject(event, this.state.task)}
            >
              Update
            </button>
            <br />
            ...
            <button
              type="update"
              onClick={event => this.deletetask(event, this.state.task)}
            >
              Delete
            </button>
            <br />
