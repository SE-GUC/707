...
export default class partnershowAwaitingtasks extends Component {
    ...
    onSubmit(Projectid, Taskid) {
        ...
        axios.delete('http://localhost:5000/api/partners/project/tasks/' + Projectid + '/' + Taskid, {
            headers: {
    ...
    rerender(token, Projectid) {
        axios.get('http://localhost:5000/api/partners/project/tasks/' + Projectid, {
            headers: {
    ...
    editTask(task) {
        ...
        axios.put('http://localhost:5000/api/partners/project/tasks/'+{project}.project+'/'+task._id,updatedTask,{
            headers: {
                Authorization: token
            }
        }).then(res => {
    ...
    deleteOneTask(task) {
        ...
        const token = cookies.get('token');
        const {project}=this.props.match.params;
        axios.delete('http://localhost:5000/api/partners/project/tasks/'+{project}.project+'/'+task._id,{
            headers: {
                Authorization: token
            }
        }).then(res => {
                ...
                return (
                    <Form>
                        ...
                        <Form.Group controlId="formTotal">
                            ...
                            <Form.Control type="text" placeholder={this.state.taskCandidateRole} onChange={this.onChangeTaskCandidateRole} />
                        </Form.Group>
                        <Form.Group controlId="formTotal">
                        ...
                        <button id="btn1" onClick={this.editTask.bind(this, this.state.task)}>Edit</button>
                        ...
                        <Table striped bordered hover variant="dark">
                            ...
                            {this.state.tasks.map(person =>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                    <td><button id="btn1" onClick={this.editOneTask.bind(this, person)}>Edit</button></td>
                                    <td><button id="btn1" onClick={this.deleteOneTask.bind(this, person)}>Delete</button></td>
