...
export default class adminShowAwaitingProjects extends Component {
  ...
  editTask(task) {
    ...
    axios
      .put(
        "http://localhost:5000/api/admins/project/" + task._id,
        updatedTask,
        {
          headers: {
            Authorization: token
      ...
      return (
        <Form>
          ...
          <button
            ...
            onClick={this.editTask.bind(this, this.state.task)}
          >
            Edit
          </button>
        </Form>
                ...
                <tr>
                  ...
                  <td>
                    <button
                      ...
                      type="button"
                      className="btn btn-primary"
                      onClick={this.editOneProject.bind(this, person)}
                    >
                      Edit
                    </button>
                  </td>
                  <td>
                    <button
                      ...
                      onClick={this.deleteOneProject.bind(this, person)}
                    >
                      Delete
                    </button>
                  </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <button
                        ...
                        type="button"
                        className="btn btn-primary"
                        onClick={this.editOneTask.bind(this, personx, person)}
                      >
                        Edit
                      </button>
                    </td>
                    <td>
                      <button
                        ...
                        type="button"
                        className="btn btn-danger"
                        onClick={this.deleteOneTask.bind(this, personx)}
                      >
                        Delete
                      </button>
                    </td>
        ...
        <ul>
          ...
          <Form>
            ...
            <button
              ...
              type="button"
              className="btn btn-success"
              onClick={this.editTask2.bind(this, this.state.task2)}
            >
              Edit
            </button>
          </Form>
