...
export default class consultancyrecprojects extends Component {
  ...
  componentDidMount() {
    ...
    axios
      ...
      .then(res => {
        axios
          .get("http://localhost:5000/api/consultancies/pendingProjects", {
            headers: {
              Authorization: token
            }
          })
  ...
  onSubmitDisapply(id) {
    ...
    const token = cookies.get("token");
    axios
      .delete("http://localhost:5000/api/consultancies/project/" + id, {
        headers: {
          Authorization: token
        }
      })
              ...
              <tr>
                ...
                <td>
                  ...
                  <input
                    ...
                    onClick={
                      project.buttonId === "pending"
                        ? this.onSubmitDisapply.bind(this, project._id)
                        : this.onSubmitApply.bind(this, project._id)
                    }
                    value={
                      project.buttonId === "pending" ? "Disapply" : "Apply"
                    }
                  />
                </td>
              </tr>
