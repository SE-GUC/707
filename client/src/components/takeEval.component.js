...
export default class takeEval extends Component {
    constructor(props) {
      ...
      componentDidMount() {
        ...
        axios
          .get("http://localhost:5000/api/candidates/certificate/evaluationTest/"+{evaluation}.evaluation, {
            headers: {
              Authorization: token
            }
          })
      ...
      submitEval(id) {
        ...
        axios
          .post("http://localhost:5000/api/candidates/certificate/evaluationTests/"+{certificate}.certificate+"/"+{evaluation}.evaluation,answer,{
            headers: {
              Authorization: token
            }
