...
export default class viewOneEvaluation_Admin extends Component {
    ...
    componentDidMount() {
     ...
     console.log({evaluation}.evaluation);
        ...
        axios.get('http://localhost:5000/api/admins/certificate/evaluationTest/'+{evaluation}.evaluation, {
          headers: {
            Authorization: token
          }
        })
          .then(res => {
            ...
            this.setState({ evaluationContent:evaluations.evaluationContent,
