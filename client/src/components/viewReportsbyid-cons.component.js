...
export default class getallReports extends Component {
  ...
  onSubmit(e) {
    ...
    axios
      .post("http://localhost:5000/api/consultancies/report", report, {
        headers: {
          Authorization: token
        }
      })
  ...
  componentDidMount() {
    ...
    const token = cookies.get("token");
    axios
      .get("http://localhost:5000/api/consultancies/reports", {
        headers: {
          Authorization: token
        }
      })
  ...
  onSubmit2(id) {
    ...
    axios
      .delete("http://localhost:5000/api/consultancies/report/" + id, {
        headers: {
          Authorization: token
        }
      })
  ...
  onSubmit3(id) {
    ...
    axios
      .get("http://localhost:5000/api/consultancies/report/" + id, {
        headers: {
          Authorization: token
        }
      })
