...
export default class getAnnouncementbyID_Partner extends Component {
    ...
    state = {
      ...
      componentDidMount() {
        ...
        axios.get("http://localhost:5000/api/partners/announcements", {  headers: {
          Authorization: token}
        })
          .then(res => {
      ...
      onSubmit(id) {
        ...
        axios.get('http://localhost:5000/api/partners/announcement/'+ id, { headers: {
                      ...
                      {this.state.announcements.map(person =>
                          ...
                          <tbody>
                              <tr >
                                  ...
                                  <sp> </sp> <button type="button" className="btn btn-primary" onClick={this.viewOneAnnouncement.bind(this, person)}>View</button><br></br>
