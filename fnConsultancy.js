...
const functions = {
  ...
  getConsultancy: async (token) => {
    const response = await axios.get(
      "http://localhost:5000/api/consultancies/profile", {
        headers: {
          Authorization: token
        }
      }
  ...
  putConsultancy: async (cons, token) => {
    const response = await axios.put(
      "http://localhost:5000/api/consultancies/updateProfile", cons, {
        headers: {
          Authorization: token
        }
      }
  ...
  deleteconsultancy: async (token) => {
    const response = await axios.delete(
      "http://localhost:5000/api/consultancies/delete", {
        headers: {
          Authorization: token
        }
      }
  ...
  postConversation: async (cons, token) => {
    const response = await axios.post(
      "http://localhost:5000/api/consultancies/conversations/start", cons, {
        headers: {
          Authorization: token
        }
      }
  ...
  getConversationbyemail: async (token, email) => {
    const response = await axios.get(
      "http://localhost:5000/api/consultancies/conversations/get/" + email, {
        headers: {
          Authorization: token
        }
      }
  ...
  deleteConversation: async (email, token) => {
    const response = await axios.delete(
      "http://localhost:5000/api/consultancies/conversations/delete/" + email, {
        headers: {
          Authorization: token
        }
      }
  ...
  getAllCons: async (token) => {
    const response = await axios.get(
      "http://localhost:5000/api/consultancies/conversations/get", {
        headers: {
          Authorization: token
        }
      }
  ...
  postemailConversation: async (cons, token) => {
    const response = await axios.post(
      "http://localhost:5000/api/consultancies/conversations/send", cons, {
        headers: {
          Authorization: token
        }
      }
  ...
  getProjectbyid: async (projectid, token) => {
    const response = await axios.get(
      "http://localhost:5000/api/consultancies/project/select/" + projectid, {
        headers: {
          Authorization: token
        }
      }
