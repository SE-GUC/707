...
router.put("/certificate/:certificateID", async (req, res) => {
    try {
...
router.delete("/certificate/:certificateID", async (req, res) => {
    try {
...
router.post("/certificate/evaluationTests/:certificateID", async (req, res) => {
    try {
                    ...
                    function (err, foundCertificate) {
                        if (!err)
                            if (!foundCertificate)
                                ...
                                res.json({
                                    msg: "Your evaluation test has been added to your certificate successfully",
...
router.delete("/certificate/evaluationTests/:certificateID/:evaluationID", async (req, res) => {
    try {
        Evaluation.findByIdAndDelete(req.params.evaluationID, function (err, deletedEvaluation) {
            if (!err)
                if (!deletedEvaluation)
                    ...
                    Certificate.findByIdAndUpdate(req.params.certificateID, {
                        $pull: {
...
router.put("/acquiredCertificates/:certificateID/:candidateID", async (req, res) => {
    try {
        Certificate.findById(req.params.certificateID, function (err, foundCertificate) {
            if (!err)
                if (!foundCertificate)
                    ...
                    Candidate.update({
                        ...
                        function (err) {
                            if (!err)
                                res.json({
                                    msg: "Now this certificate's evaluation is approved and posted on your profile",
                                    data: foundCertificate
                                });
                            else res.json({
                                error: err.message
